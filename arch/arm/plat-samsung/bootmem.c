...
/* samsung 2d & 3d support */
#define CONFIG_VIDEO_SAMSUNG_MEMSIZE_PMEM		(16 * 1024)
#if defined(CONFIG_VIDEO_G3D)
#define CONFIG_VIDEO_SAMSUNG_MEMSIZE_PMEM_GPU1	(32 * 1024)
#define CONFIG_VIDEO_SAMSUNG_MEMSIZE_PMEM_ADSP	( 8 * 1024)
#endif
...
static struct s3c_media_device s3c_mdevs[S3C_MDEV_MAX] = {
...

	{
		.id = S3C_MDEV_PMEM,
		.name = "pmem",
#ifdef CONFIG_VIDEO_SAMSUNG_MEMSIZE_PMEM
		.memsize = CONFIG_VIDEO_SAMSUNG_MEMSIZE_PMEM * SZ_1K,
#else
		.memsize = 0,
#endif
		.paddr = 0,
	},
	{
		...
		.name = "pmem_gpu1",
#ifdef CONFIG_VIDEO_SAMSUNG_MEMSIZE_PMEM_GPU1
		.memsize = CONFIG_VIDEO_SAMSUNG_MEMSIZE_PMEM_GPU1 * SZ_1K,
#else
		.memsize = 0,
#endif
		.paddr = 0,
	},
	{
		...
		.name = "pmem_adsp",
#ifdef CONFIG_VIDEO_SAMSUNG_MEMSIZE_PMEM_ADSP
		.memsize = CONFIG_VIDEO_SAMSUNG_MEMSIZE_PMEM_ADSP * SZ_1K,
#else
		.memsize = 0,
#endif
		.paddr = 0,
